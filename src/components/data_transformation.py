...
class DataTransforamtion:
        ...
        try:
            ...
            cat_pipeine = Pipeline(
                steps=[
                    ...
                    ('ordinalenocde',OrdinalEncoder(categories=[cut_categories,color_categories,clarity_categories])),
                    ('scaler',StandardScaler())
                ]
            )
            ...
            preprocessor = ColumnTransformer(
                ...
                ('cat_pipeine',cat_pipeine,categorical_cols)]
            )
    ...
    def initialize_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Applying preprocessor on test and train data")
            ##transforming using prerocessor
            input_feature_test_arr = preprocessing_obj.fit_transform(input_feature_train_df)
            input_feature_train_arr = preprocessing_obj.trasform(input_feature_test_df)
